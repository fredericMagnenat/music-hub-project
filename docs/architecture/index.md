...
- [Music Hub Fullstack Architecture Document](#table-of-contents)
  ...
  - [Architectural and Design Patterns](./architectural-and-design-patterns.md)
  ...
  - [Business Logic Implementation](./business-logic-implementation.md)
    - [Data Consistency and Source of Truth](./business-logic-implementation.md#data-consistency-and-source-of-truth)
    - [Correlation ID Pattern Implementation](./business-logic-implementation.md#correlation-id-pattern-implementation)
      - [Pattern Overview](./business-logic-implementation.md#pattern-overview)
      - [Implementation Strategy](./business-logic-implementation.md#implementation-strategy)
      - [Key Benefits](./business-logic-implementation.md#key-benefits)
      - [Usage Examples](./business-logic-implementation.md#usage-examples)
      - [Testing Strategy](./business-logic-implementation.md#testing-strategy)
      - [Best Practices](./business-logic-implementation.md#best-practices)
      - [Integration with Monitoring](./business-logic-implementation.md#integration-with-monitoring)
  ...
  - [Logging Best Practices](./logging-best-practices.md)
    ...
    - [Contextual Logging & Correlation](./logging-best-practices.md#contextual-logging-correlation)
      - [Correlation ID Implementation](./logging-best-practices.md#correlation-id-implementation)
    ...
    - [OpenTelemetry Integration](./logging-best-practices.md#opentelemetry-integration)
      - [Correlation ID Integration](./logging-best-practices.md#correlation-id-integration)
    ...
    - [Business Event Logging](./logging-best-practices.md#business-event-logging)
      - [Correlation ID in Business Events](./logging-best-practices.md#correlation-id-in-business-events)
    - [Monitoring & Alerting](./logging-best-practices.md#monitoring-alerting)
      - [Correlation ID-Based Monitoring](./logging-best-practices.md#correlation-id-based-monitoring)
  ...
  - [Testing Best Practices](./testing-best-practices.md)
    ...
    - [Backend Testing Standards](./testing-best-practices.md#backend-testing-standards)
      ...
      - [Correlation ID Testing Standards](./testing-best-practices.md#correlation-id-testing-standards)
        - [✅ Excellent Example from Our Codebase](./testing-best-practices.md#excellent-example-from-our-codebase)
        - [Correlation ID Testing Standards](./testing-best-practices.md#correlation-id-testing-standards)
        - [Service-Specific Correlation ID Tests](./testing-best-practices.md#service-specific-correlation-id-tests)
  ...
  - [Detailed Frontend Structure](./detailed-frontend-structure.md)
    ...
    - [Component Philosophy](./detailed-frontend-structure.md#component-philosophy)
    - [API Integration](./detailed-frontend-structure.md#api-integration)
    - [State Management](./detailed-frontend-structure.md#state-management)
    - [Testing Strategy](./detailed-frontend-structure.md#testing-strategy)
