 ...
 * Provides a producer method to inject all available ArtistReconciliationPort
 * implementations.
 */
@ApplicationScoped
public class ArtistReconciliationConfig {
    ...
    @Produces
    @ApplicationScoped
    public List<ArtistReconciliationPort> reconciliationPorts(
            @Any Instance<ArtistReconciliationPort> reconciliationPorts) {
